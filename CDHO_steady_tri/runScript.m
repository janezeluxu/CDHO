...
%     Lineplotfilename = strcat('./testvtk/cases/',casefile,'solution/',casefile,order,itaucase,k,'line.txt')
...
%     figure(2)
%     x = -sqrt(2)/4:0.001:sqrt(2)/4;
%     y = x+sqrt(2)/2;
%     [concentration]=LinePlot(meshFile,solutionFile,x,y);
%     s = (x+y)/(sqrt(2));
%     plot(s,concentration,'b-')
%     hold on
