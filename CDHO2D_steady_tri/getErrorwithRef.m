...
[L2Error,H1Error]=...
    getError(fileNameM1,fileNameM2,solutionFileM1,solutionFileM2,refineLevel)

end


function [L2Error,H1Error,H1]=getError(fileNameM1,fileNameM2,solutionFileM1,solutionFileM2,refineLevel)
%refineLevel = 2;
nInt = 20;
global Grid_size;
...
[L2Error,H1Errorx,H1Errory,H1]=calcuError(pM1,pM2,uM1,uM2,nInt,Grid_sizeM1,refineLevel,...
...
function [L2Error,H1Errorx,H1Errory,H1]=calcuError(pM1,pM2,uM1,uM2,nInt,Grid_sizeM1,refineLevel,...
                meshDataM2,solution_ienM2,p_ienM2,vertexDataM2,...
                meshDataM1,solution_ienM1,p_ienM1,vertexDataM1)
