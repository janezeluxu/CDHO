function[pOrder,meshData,vertexData,Area,...
    IBC,IBC_vertex,BCval,BCb,uHBCnode,solutionIEN,p_list,edge_usage,...
...
uHBCnode = findtaunode(BCb,mesh_ien,IBC,vertexData,BCval);
%uHBCE = [];
%Build periodic
...
function uHBCnode = findtaunode(BCb,ien_map,IBC,vertexData,BCval)
global node_Size
